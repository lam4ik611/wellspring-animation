...
/***/ "./assets/js/animation/gsap/Draggable.js":
/*!***********************************************!*\
  !*** ./assets/js/animation/gsap/Draggable.js ***!
  \***********************************************/
...
/***/ "./assets/js/animation/gsap/utils/matrix.js":
/*!**************************************************!*\
  !*** ./assets/js/animation/gsap/utils/matrix.js ***!
  \**************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst getScrollSpeed = function (settings) {\n  settings = settings || {};\n  let lastPos,\n      newPos,\n      timer,\n      delta,\n      delay = settings.delay || 50; // in \"ms\" (higher means lower fidelity )\n\n  function clear() {\n    lastPos = null;\n    delta = 0;\n  }\n\n  clear();\n  return function () {\n    newPos = window.scrollY;\n\n    if (lastPos != null) {\n      // && newPos < maxScroll\n      delta = newPos - lastPos;\n    }\n\n    lastPos = newPos;\n    clearTimeout(timer);\n    timer = setTimeout(clear, delay);\n    return delta;\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getScrollSpeed);\n\n//# sourceURL=webpack:///./assets/js/util/scrollSpeed.js?");
